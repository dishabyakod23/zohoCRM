...
export function normalizeSalesTargetReportRow(row) {
  ...
  return {
    ...
    actuals: {
      ...
      new_leads: Number(row.actuals?.new_leads || 0),
      prospects_contacted: Number(row.actuals?.prospects_contacted || 0),
      cold_calls: Number(row.actuals?.cold_calls || 0),
      emails_sent: Number(row.actuals?.emails_sent || 0),
      linkedin_outreach: Number(row.actuals?.linkedin_outreach || 0),
      follow_ups: Number(row.actuals?.follow_ups || 0),
      meetings_completed: Number(row.actuals?.meetings_completed || 0),
    },
